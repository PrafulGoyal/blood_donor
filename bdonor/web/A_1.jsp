...
<div id="wb_Form1" style="position:absolute;left:202px;top:211px;width:534px;height:406px;z-index:13;">
<form name="contact" action="/sendfeed" method="post" id="Form1" onsubmit="return Validatecontact(this)">
...
<input type="submit" id="Button1" name="submit" value="Submit" style="position:absolute;left:94px;top:345px;width:96px;height:25px;z-index:12;">
</form>
</div>
</body>
</html>