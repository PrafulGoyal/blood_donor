...
<div id="wb_Form1" style="position:absolute;left:500px;top:250px;width:346px;height:243px;z-index:9;">
    ...
    <center>
        <t:form  method="post"  action="/jfind"  onsubmit="return ValidateForm1(this)">
...
<input type="submit" id="Button1"  name="find" value="Find Blood" style="background-color: red; position:absolute;left:175px;top:180px;width:103px;height:27px;z-index:8;">
        </t:form></center>
