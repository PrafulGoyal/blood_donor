<%-- 
    Document   : facts
    Created on : Nov 29, 2014, 9:39:44 PM
...
<html>
   ...
   <h1 align="center" >Blood Donation Facts</h1>
                                        <table align="center" id="Table1" cellpadding="5" cellspacing="0" width="688">
                                          <tbody><tr>
                                            <td valign="top"><p class="heading_color">Facts about blood needs</p>
                                              <ul>
                                                ...
                                                blood.<img src="blood_3.jpg" align="right" height="100" width="290"></li>
                                              ...
                                              <ul>
                                                <li>Blood cannot be manufactured – it can only come from generous donors.<img src="blood_4.jpg" align="right" height="100" width="290"></li>
                                              ...
                                              <ul>
                                                <li>Donating blood is a safe process. A sterile needle is used only once for each donor and then discarded.<img src="blood_1.jpg" align="right" height="100" width="290"></li>
                                                ...
                                                <li>The average adult has about 10 units of blood in his body. Roughly 1 unit is given during a donation.<img src="blood_2.jpg" align="right" height="100" width="290"></li>
                                              ...
                                              <ul>
                                                ...
                                                <li>One donation can help save the lives of up to&nbsp;three people.<img src="blood_5.jpg" align="right" height="100" width="290"></li>
                                              ...
                                              <p>In 1901, Karl Landsteiner, an Austrian physician, discovers the first three human blood groups. On his birthday i.e June 14th "World Blood Donors Day" celebrates. On October 1st ‘National Blood Donation Day’ celebrates in India.</p>
                                              <p><strong>WHAT TYPE ARE YOU?</strong> </p>
                                              <table align="center" bgcolor="#FF0000" border="0" cellpadding="5" cellspacing="1" width="80%">
   ...
   <br></br><br></br><img src="Footer.png" width="100%" height="100" />
